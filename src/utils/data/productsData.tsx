...
// secondary category filterBar data
...
export const yearsList = [{ year: 2023 }, { year: 2022 }, { year: 2021 }, { year: 2020 }, { year: 2019 }];
export const osList = [{ os: 'Android' }, { os: 'Windows11' }, { os: 'Windows10' }, { os: 'macOS' }, { os: 'Linux' }, { os: 'iOS' }];
